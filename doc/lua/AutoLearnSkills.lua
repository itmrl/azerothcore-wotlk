print(">>Script: AutoLearnSkills loading...OK")
...
local SKILL = {--技能表
    ...
    [CLASS_HUNTER] = {--猎人
        ...
        [6] = { 3044, 1130 },
        [8] = { 5116, 14260 },
        [10] = { 13165, 13549, 19883, 883, 982, 1515, 1528, 2641, 6991, 5149 },
    ...
    [CLASS_DRUID] = {--德鲁伊
        ...
        [10] = { 8924, 16689, 99, 5232, 1058, 9634 },
        [12] = { 5229, 8936, 50769 },
        [14] = { 782, 5178, 5211, 5187 },
        [16] = { 8925, 779, 1430, 783 },
        [18] = { 1062, 770, 2637, 16810, 16857, 8938, 1066 },
...
RegisterPlayerEvent(13, SKILL.AutoLearn)
