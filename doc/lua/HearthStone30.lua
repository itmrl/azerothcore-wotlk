print(">>Script: HearthStone30 loading...OK")

--菜单所有者 --默认炉石6948
local itemEntry	=90002
--阵营
...
local Menu={
    [MMENU]={--主菜单
      ...
      --  {MENU, "【|cFF0000FF定点传送|r】", 			TBMENU,			GOSSIP_ICON_TAXI},
        ...
        {FUNC, "解除虚弱", 		Stone.WeakOut,		GOSSIP_ICON_INTERACT_1, false,"是否解除虚弱，并回复生命 ?",100000}
    },
    ...
    [TPMENU+0x10]={--主要城市
        ...
        {TP, "|cFF0000FF[外域]|r沙塔斯",	530,	-1887.62,	5359.09,	-12.4279,	4.40435,	TEAM_NONE,	60},--增加显示此菜单等级，传送使用金币
        {TP, "|cFF4B0082[诺森德]|r达拉然",	571,	5809.55,	503.975,	657.526,	2.38338,	TEAM_NONE,	70},
        {TP, "|cFF006400[中立]|r藏宝海湾",	0,		-14281.9,	552.564,	8.90422,	0.860144,	TEAM_NONE,	35},
        {TP, "|cFF006400[中立]|r棘齿城",	1,		-955.219,	-3678.92,	8.29946,	0,			TEAM_NONE,	10},
        {TP, "|cFF006400[中立]|r加基森",	1,		-7122.8,	-3704.82,	14.0526,	0,			TEAM_NONE,	30},
        {TP, "|cFF006400[中立]|r永望镇",	1,		6724.58,	-4609.16,	720.597,	4.87852,	TEAM_NONE,	55},--永望镇这么重要也不加一个？
    ...
    [TPMENU+0x30]={--东部王国
        {TP, "艾尔文森林",		0,		-9449.06,	64.8392,	56.3581,	3.0704,		TEAM_NONE,	1},
        {TP, "永歌森林",		530,	9024.37,	-6682.55,	16.8973,	3.1413,		TEAM_NONE,	1},
        {TP, "丹莫罗",			0,		-5603.76,	-482.704,	396.98,		5.2349,		TEAM_NONE,	1},
        {TP, "提瑞斯法林地",	0,		2274.95,	323.918,	34.1137,	4.2436,		TEAM_NONE,	1},
        {TP, "洛克莫丹",		0,		-5405.85,	-2894.15,	341.972,	5.4823,		TEAM_NONE,	10},
        {TP, "幽魂之地",		530,	7595.73,	-6819.6,	84.3718,	2.5656,		TEAM_NONE,	10},
        {TP, "西部荒野",		0,		-10684.9,	1033.63,	32.5389,	6.0738,		TEAM_NONE,	10},
        {TP, "银松森林",		0,		505.126,	1504.63,	124.808,	1.7798,		TEAM_NONE,	10},
        {TP, "赤脊山",			0,		-9447.8,	-2270.85,	71.8224,	0.28385,	TEAM_NONE,	15},--官服坐飞机都是2G起，所以并不贵
        {TP, "暮色森林",		0,		-10531.7,	-1281.91,	38.8647,	1.5695,		TEAM_NONE,	18},
        {TP, "湿地",			0,		-3517.75,	-913.401,	8.86625,	2.607,		TEAM_NONE,	20},
        {TP, "希尔斯布莱德丘陵",	0,		-385.805,	-787.954,	54.6655,	1.0392,		TEAM_NONE,	20},
        {TP, "奥特兰克山脉",	0,		275.049,	-652.044,	130.296,	0.50203,	TEAM_NONE,	25},
        {TP, "阿拉希高地",		0,		-1581.45,	-2704.06,	35.4168,	0.490373,	TEAM_NONE,	30},
        {TP, "荆棘谷",			0,		-11921.7,	-59.544,	39.7262,	3.7357,		TEAM_NONE,	30},
        {TP, "荒芜之地",		0,		-6782.56,	-3128.14,	240.48,		5.6591,		TEAM_NONE,	35},
        {TP, "悲伤沼泽",		0,		-10368.6,	-2731.3,	21.6537,	5.2923,		TEAM_NONE,	35},
        {TP, "辛特兰",			0,		112.406,	-3929.74,	136.358,	0.981903,	TEAM_NONE,	40},
        {TP, "灼热峡谷",		0,		-6686.33,	-1198.55,	240.027,	0.91688,	TEAM_NONE,	43},
        {TP, "诅咒之地",		0,		-11184.7,	-3019.31,	7.29238,	3.20542,	TEAM_NONE,	45},
        {TP, "燃烧平原",		0,		-7979.78,	-2105.72,	127.919,	5.10148,	TEAM_NONE,	50},
        {TP, "西瘟疫之地",		0,		1743.69,	-1723.86,	59.6648,	5.23722,	TEAM_NONE,	51},
        {TP, "东瘟疫之地",		0,		2280.64,	-5275.05,	82.0166,	4.747,		TEAM_NONE,	53},
        {TP, "奎尔丹纳斯岛",	530,	12806.5,	-6911.11,	41.1156,	2.2293,		TEAM_NONE,	68},
    },

    [TPMENU+0x40]={--卡利姆多
        {TP, "秘蓝岛",			530,	-4192.62,	-12576.7,	36.7598,	1.62813,	TEAM_NONE,	1},
        {TP, "秘血岛",			530,	-2095.7,	-11841.1,	51.1557,	6.19288,	TEAM_NONE,	1},
        {TP, "泰达希尔",		1,		9889.03,	915.869,	1307.43,	1.9336,		TEAM_NONE,	1},
        {TP, "杜隆塔尔",		1,		228.978,	-4741.87,	10.1027,	0.416883,	TEAM_NONE,	1},
        {TP, "莫高雷",			1,		-2473.87,	-501.225,	-9.42465,	0.6525,		TEAM_NONE,	1},
        {TP, "黑海岸",			1,		6463.25,	683.986,	8.92792,	4.33534,	TEAM_NONE,	10},
        {TP, "贫瘠之地",		1,		-1028.95,	-2462.17,	91.6679,	5.83412,	TEAM_NONE,	10},
        {TP, "石爪山脉",		1,		1574.89,	1031.57,	137.442,	3.8013,		TEAM_NONE,	15},
        {TP, "灰谷",			1,		1919.77,	-2169.68,	94.6729,	6.14177,	TEAM_NONE,	18},
        {TP, "千针石林",		1,		-5375.53,	-2509.2,	-40.432,	2.41885,	TEAM_NONE,	30},
        {TP, "凄凉之地",		1,		-656.056,	1510.12,	88.3746,	3.29553,	TEAM_NONE,	30},
        {TP, "尘泥沼泽",		1,		-3350.12,	-3064.85,	33.0364,	5.12666,	TEAM_NONE,	35},
        {TP, "菲拉斯",			1,		-4808.31,	1040.51,	103.769,	2.90655,	TEAM_NONE,	40},
        {TP, "塔纳利斯沙漠",	1,		-6940.91,	-3725.7,	48.9381,	3.11174,	TEAM_NONE,	40},
        {TP, "艾萨拉",			1,		3117.12,	-4387.97,	91.9059,	5.49897,	TEAM_NONE,	45},
        {TP, "费伍德森林",		1,		3898.8,		-1283.33,	220.519,	6.24307,	TEAM_NONE,	48},
        {TP, "安戈洛环形山",	1,		-6291.55,	-1158.62,	-258.138,	0.457099,	TEAM_NONE,	48},
        {TP, "希利苏斯",		1,		-6815.25,	730.015,	40.9483,	2.39066,	TEAM_NONE,	50},
        {TP, "冬泉谷",			1,		6658.57,	-4553.48,	718.019,	5.18088,	TEAM_NONE,	55},
    },

    [TPMENU+0x50]={--外域
        {TP, "地狱火半岛",		530,	-207.335,	2035.92,	96.464,		1.59676,	TEAM_NONE,	60},
        {TP, "地狱火半岛-荣耀堡",	530,	-683.05,	2657.57,	91.04,		1,		TEAM_ALLIANCE,	60},
        {TP, "地狱火半岛-萨尔玛",	530,	139.96,		2671.51,	85.509,		1,		TEAM_HORDE,		60},
        {TP, "赞加沼泽",		530,	-220.297,	5378.58,	23.3223,	1.61718,	TEAM_NONE,	62},
        {TP, "泰罗卡森林",		530,	-2266.23,	4244.73,	1.47728,	3.68426,	TEAM_NONE,	64},
        {TP, "纳格兰",			530,	-1610.85,	7733.62,	-17.2773,	1.33522,	TEAM_NONE,	64},
        {TP, "刀锋山",			530,	2029.75,	6232.07,	133.495,	1.30395,	TEAM_NONE,	66},
        {TP, "虚空风暴",		530,	3271.2,		3811.61,	143.153,	3.44101,	TEAM_NONE,	68},
        {TP, "影月谷",			530,	-3681.01,	2350.76,	76.587,		4.25995,	TEAM_NONE,	68},
    },

    [TPMENU+0x60]={--诺森德
        {TP, "北风苔原",		571,	2954.24,	5379.13,	60.4538,	2.55544,	TEAM_NONE,	68},
        {TP, "凛风峡湾",		571,	682.848,	-3978.3,	230.161,	1.54207,	TEAM_NONE,	68},
        {TP, "龙骨荒野",		571,	2678.17,	891.826,	4.37494,	0.101121,	TEAM_NONE,	71},
        {TP, "灰熊丘陵",		571,	4017.35,	-3403.85,	290,		5.35431,	TEAM_NONE,	73},
        {TP, "祖达克",			571,	5560.23,	-3211.66,	371.709,	5.55055,	TEAM_NONE,	74},
        {TP, "索拉查盆地",		571,	5614.67,	5818.86,	-69.722,	3.60807,	TEAM_NONE,	75},
        {TP, "水晶之歌森林",	571,	5411.17,	-966.37,	167.082,	1.57167,	TEAM_NONE,	74},
        {TP, "风暴峭壁",		571,	6120.46,	-1013.89,	408.39,		5.12322,	TEAM_NONE,	76},
        {TP, "冰冠冰川",		571,	8323.28,	2763.5,		655.093,	2.87223,	TEAM_NONE,	77},
        {TP, "冬拥湖",			571,	4522.23,	2828.01,	389.975,	0.215009,	TEAM_NONE,	77},
    },

    [TPMENU+0x70]={--经典旧世界地下城★
        {TP, "怒焰裂谷",		1,		1811.78,	-4410.5,	-18.4704,	5.20165,	TEAM_NONE,	8},
        {TP, "死亡矿井",		0,		-11209.6,	1666.54,	24.6974,	1.42053,	TEAM_NONE,	10},
        {TP, "哀嚎洞穴",		1,		-731.607,	-2218.39,	17.0281,	2.78486,	TEAM_NONE,	10},
        {TP, "影牙城堡",		0,		-234.675,	1561.63,	76.8921,	1.24031,	TEAM_NONE,	10},
        {TP, "暴风城监狱",		0,		-8799.15,	832.718,	97.6348,	6.04085,	TEAM_NONE,	15},
        {TP, "剃刀沼泽",		1,		-4470.28,	-1677.77,	81.3925,	1.16302,	TEAM_NONE,	17},
        {TP, "黑暗深渊",		1,		4249.99,	740.102,	-25.671,	1.34062,	TEAM_NONE,	19},
        {TP, "诺莫瑞根",		0,		-5163.54,	925.423,	257.181,	1.57423,	TEAM_NONE,	20},
        {TP, "血色修道院",		0,		2873.15,	-764.523,	160.332,	5.10447,	TEAM_NONE,	20},
        {TP, "剃刀高地",		1,		-4657.3,	-2519.35,	81.0529,	4.54808,	TEAM_NONE,	25},
        {TP, "奥达曼",			0,		-6071.37,	-2955.16,	209.782,	0.015708,	TEAM_NONE,	30},
        {TP, "玛拉顿",			1,		-1421.42,	2907.83,	137.415,	1.70718,	TEAM_NONE,	30},
        {TP, "祖尔法拉克",		1,		-6801.19,	-2893.02,	9.00388,	0.158639,	TEAM_NONE,	35},
        {TP, "阿塔哈卡神庙",	0,		-10177.9,	-3994.9,	-111.239,	6.01885,	TEAM_NONE,	35},
        {TP, "黑石深渊",		0,		-7179.34,	-921.212,	165.821,	5.09599,	TEAM_NONE,	40},
        {TP, "黑石塔",			0,		-7527.05,	-1226.77,	285.732,	5.29626,	TEAM_NONE,	45},
        {TP, "厄运之槌",		1,		-3520.14,	1119.38,	161.025,	4.70454,	TEAM_NONE,	45},
        {TP, "通灵学院",		0,		1269.64,	-2556.21,	93.6088,	0.620623,	TEAM_NONE,	45},
        {TP, "斯坦索姆",		0,		3352.92,	-3379.03,	144.782,	6.25978,	TEAM_NONE,	45},
    },

    [TPMENU+0x80]={--燃烧的远征地下城★
        {TP, "|cFF0000FF地狱火堡垒[地狱火城墙]|r",	530,	-360.671,	3071.90,	-15.1,		1.883,		TEAM_NONE,	60},
        {TP, "|cFF0000FF地狱火堡垒[鲜血熔炉]|r",	530,	-296.487,	3154.6098,	31.617,		2.24,		TEAM_NONE,	60},
        {TP, "|cFF0000FF地狱火堡垒[破碎大厅]|r",	530,	-308.05,	3066.98,	-3.018,		1.76,		TEAM_NONE,	60},
        {TP, "|cFF0000FF盘牙水库[奴隶围栏]|r",		530,	727.828,	7011.997,	-71.861,	0.245473,	TEAM_NONE,	60},
        {TP, "|cFF0000FF盘牙水库[幽暗沼泽]|r",		530,	777.089,	6763.45,	-72.066,	5.03985,	TEAM_NONE,	60},
        {TP, "|cFF0000FF盘牙水库[蒸汽地窟]|r",		530,	817.459,	6934.923,	-80.624,	1.51974,	TEAM_NONE,	60},
        {TP, "|cFF0000FF奥金顿[塞泰克大厅]|r",		530,	-3362.165,	4826.771,	-101.396,	4.73,		TEAM_NONE,	60},
        {TP, "|cFF0000FF奥金顿[法力陵墓]|r",		530,	-3243.83,	4942.69,	-101.364,	0,			TEAM_NONE,	60},
        {TP, "|cFF0000FF奥金顿[奥金尼地穴]|r",		530,	-3362.06,	5059.393,	-101.396,	1.573,		TEAM_NONE,	61},
        {TP, "|cFF4B0082奥金顿[暗影迷宫]|r",		530,	-3494.912,	4943.865,	-101.393,	3.125,		TEAM_NONE,	65},
        {TP, "|cFF4B0082时光之穴[黑色沼泽]|r",		1,		-8742.04,	-4217.996,	-209.5,		2.1,		TEAM_NONE,	66},
        {TP, "|cFF4B0082时光之穴[旧希尔斯布莱德丘陵]|r",	1,		-8391.215,	-4064.293,	-208.585,	0.199,		TEAM_NONE,	66},
        {TP, "|cFF4B0082风暴要塞[禁魔监狱]|r",		530,	3281.65,	1408.55,	502.413,	5.22,		TEAM_NONE,	68},
        {TP, "|cFF4B0082风暴要塞[生态船]|r",		530,	3351.35,	1530.116,	179.69,		5.63,		TEAM_NONE,	68},
        {TP, "|cFF4B0082风暴要塞[能源舰]|r",		530,	2926.8,		1603.597,	249,		3.91,		TEAM_NONE,	68},
        {TP, "|cFF4B0082魔导师平台|r",				530,	12884.6,	-7317.69,	65.5023,	4.799,		TEAM_NONE,	68},
    },

    [TPMENU+0x90]={--巫妖王之怒地下城★
        {TP, "|cFF4B0082乌特加德城堡|r",	571,	1203.41,	-4868.59,	41.2486,	0.283237,	TEAM_NONE,	65},
        {TP, "|cFF4B0082魔枢|r",			571,	3782.89,	6965.23,	105.088,	6.14194,	TEAM_NONE,	66},
        {TP, "|cFF4B0082艾卓-尼鲁布|r",		571,	3707.86,	2150.23,	36.76,		3.22,		TEAM_NONE,	67},
        {TP, "|cFF4B0082达克萨隆要塞|r",	571,	4765.59,	-2038.24,	229.363,	0.887627,	TEAM_NONE,	69},
        {TP, "|cFF4B0082紫罗兰监狱|r",		571,	5693.08,	502.588,	652.672,	4.0229,		TEAM_NONE,	70},
        {TP, "|cFFB22222古达克|r",			571,	6722.44,	-4640.67,	450.632,	3.91123,	TEAM_NONE,	71},
        {TP, "|cFFB22222岩石大厅|r",		571,	8922.12,	-1009.16,	1039.56,	1.57044,	TEAM_NONE,	72},
        {TP, "|cFFB22222净化斯坦索姆|r",	1,		-8756.39,	-4440.68,	-199.489,	4.66289,	TEAM_NONE,	75},
        {TP, "|cFFB22222闪电大厅|r",		571,	9136.52,	-1311.81,	1066.29,	5.19113,	TEAM_NONE,	75},
        {TP, "|cFFB22222乌特加德之巅|r",	571,	1267.24,	-4857.3,	215.764,	3.22768,	TEAM_NONE,	75},
        {TP, "|cFFB22222冰封大殿|r[灵魂洪炉/映像大厅/萨隆矿坑]",571,5643.16,2028.81,798.274,4.60242,TEAM_NONE,	80},
        {TP, "|cFFB22222冠军的试炼|r",		571,	8590.95,	791.792,	558.235,	3.13127,	TEAM_NONE,	80},
    },

    [TPMENU+0xa0]={--团队地下城★
        {TP, "|cFF0000FF【40人】熔火之心|r",		230,	1126.64,	-459.94,	-102.535,	3.46095,	TEAM_NONE,	50},
        {TP, "|cFF0000FF【40人】奥妮克希亚的巢穴|r", 1,		-4708.27,	-3727.64,	54.5589,	3.72786,	 TEAM_NONE,	50},
        {TP, "|cFF0000FF【40人】黑翼之巢|r",		229,	152.451,	-474.881,	116.84,		0.001073,	TEAM_NONE,	60},
        {TP, "|cFF0000FF【20人】祖尔格拉布|r",		0,		-11916.7,	-1215.72,	92.289,		4.72454,	TEAM_NONE,	50},
        {TP, "|cFF0000FF【20人】安其拉废墟|r",		1,		-8409.82,	1499.06,	27.7179,	2.51868,	TEAM_NONE,	50},
        {TP, "|cFF0000FF【40人】安其拉神殿|r",		1,		-8240.09,	1991.32,	129.072,	0.941603,	TEAM_NONE,	50},
        {TP, "|cFF0000FF【40人】纳克萨玛斯|r",		329,	3929.59,	-3380.76,	119.68,		1.629702,	TEAM_NONE,	60},
        {TP, "|cFF4B0082【25人】格鲁尔的巢穴|r",	530,	3530.06,	5104.08,	3.50861,	5.51117,	TEAM_NONE,	65},
        {TP, "|cFF4B0082【25人】玛瑟里顿的巢穴|r",	530,	-336.411,	3130.46,	-102.928,	5.20322,	TEAM_NONE,	65},
        {TP, "|cFF4B0082【10人】卡拉赞|r",			0,		-11119.11,	-2011.15,	47.0847,	0.695068,	TEAM_NONE,	68},
        {TP, "|cFF4B0082【25人】毒蛇神殿|r",		530,	797.855,	6865.77,	-65.4165,	0.005938,	TEAM_NONE,	70},
        {TP, "|cFF4B0082【25人】风暴要塞|r",		530,	3088.49,	1381.57,	184.863,	4.61973,	TEAM_NONE,	70},
        {TP, "|cFF4B0082【25人】海加尔峰|r",		1,		-8177.89,	-4181.23,	-167.552,	0.913338,	TEAM_NONE,	70},
        {TP, "|cFF4B0082【25人】黑暗神殿|r",		530,	-3649.92,	317.469,	35.2827,	2.94285,	TEAM_NONE,	70},
        {TP, "|cFF4B0082【10人】祖阿曼|r",			530,	6851.78,	-7972.57,	179.242,	4.64691,	TEAM_NONE,	68},
        {TP, "|cFF4B0082【25人】太阳之井高地|r",	530,	12574.1,	-6774.81,	15.0904,	3.13788,	TEAM_NONE,	70},
        {TP, "|cFFB22222【10人/25人】阿尔卡冯的宝库|r",571,	5453.72,	2840.79,	421.28,		0.01,		TEAM_NONE,	80},
        {TP, "|cFFB22222【10人/25人】纳克萨玛斯|r",	571,	3668.72,	-1262.46,	243.622,	4.785,		TEAM_NONE,	80},
        {TP, "|cFFB22222【10人/25人】黑曜石圣殿|r",	571,	3472.43,	264.923,	-120.146,	3.27923,	TEAM_NONE,	80},
        {TP, "|cFFB22222【10人/25人】永恒之眼|r",	571,	3784.17,	7028.84,	161.258,	5.79993,	TEAM_NONE,	80},
        {TP, "|cFFB22222【10人/25人】奥杜尔|r",		571,	9222.88,	-1113.59,	1216.12,	6.27549,	TEAM_NONE,	80},
        {TP, "|cFFB22222【10人/25人】奥妮克希亚的巢穴|r",1,	-4708.27,	-3727.64,	54.5589,	3.72786,	TEAM_NONE,	80},
        {TP, "|cFFB22222【10人/25人】十字军的试炼|r",571,	8515.61,	714.153,	558.248,	1.57753,	TEAM_NONE,	80},
        {TP, "|cFFB22222【10人/25人】冰冠堡垒|r",	571,	5855.22,	2102.03,	635.991,	3.57899,	TEAM_NONE,	80},
        {TP, "|cFFB22222【10人/25人】红玉圣殿|r",	571,	3590.70,	210.56,	   -120.146,	5.350949,	TEAM_NONE,	80},
    },
